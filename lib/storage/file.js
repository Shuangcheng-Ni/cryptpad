...
var mkPath = function (env, channelId) {
    ...
    // console.log("path=" + Path.join(env.root, channelId.slice(0, 2), channelId) + '.ndjson');
    // console.log('\n\n\n\n\n\n');
...
var mkArchivePath = function (env, channelId) {
    ...
    // console.log("env=" + env);
    // console.log("channelId=" + channelId);
    // console.log("path=" + Path.join(env.archiveRoot, env.volumeId, channelId.slice(0, 2), channelId) + '.ndjson');
    // console.log('\n\n\n\n\n\n');
...
var mkMetadataPath = function (env, channelId) {
    ...
    // console.log("env=" + env);
    // console.log("channelId=" + channelId)
    // console.log("path=" + Path.join(env.root, channelId.slice(0, 2), channelId) + '.metadata.ndjson');
    // console.log('\n\n\n\n\n\n');
...
var mkArchiveMetadataPath = function (env, channelId) {
    ...
    // console.log("env=" + env);
    // console.log("channelId=" + channelId)
    // console.log("path=" + Path.join(env.archiveRoot, env.volumeId, channelId.slice(0, 2), channelId) + '.metadata.ndjson');
    // console.log('\n\n\n\n\n\n');
