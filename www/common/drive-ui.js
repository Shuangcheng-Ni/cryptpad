define([
    ...
    var create = function (common, driveConfig) { //proxy, folders) {
        ...
        var createInfoBox = function (path) {
            ...
            switch (path[0]) {
                case ROOT:
                    ...
                    break;
                case TEMPLATE:
                    msg = Messages.fm_info_template;//模板infobox
                    break;
                case TRASH:
        ...
        var emptyTrashModal = function () {//这是单击垃圾桶后右边展示内容
        ...
        var displayTrashRoot = function ($list, $folderHeader, $fileHeader, typeFilter) {
            ...
            if (!isEmpty) {
                var $empty = createEmptyTrashButton();//+按钮
        ...
        var _displayDirectory = function (path, force) {
            ...
            var isTemplate = manager.comparePath(path, [TEMPLATE]);//11是否是模板
