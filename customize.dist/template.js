define([
    ...
    // Abort everything if you detect that you are embedded inside an iframe.
    // We consider that there is no valid reason to load any of the info pages in an iframe.
